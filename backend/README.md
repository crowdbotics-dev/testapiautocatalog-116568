...
## Project Structure
    ...
    ├── testapiautocatalog_116568  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_116568`
...
2. Clone this repo and `cd testapiautocatalog_116568`
